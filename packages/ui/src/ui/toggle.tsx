...
const Toggle: FC<ComponentProps<typeof TogglePrimitive.Root>> = ({
  ...
  return (
    <TogglePrimitive.Root
      data-slot="toggle"
      className={cn(
        "group focus-visible:outline-accent-8 block -outline-offset-1 focus-visible:z-1 focus-visible:outline-[2px]",
      ...
      {...props}
    >
      <span className="leading-md relative flex min-w-0 flex-1 items-center gap-0.5 px-3 py-2">
        {children}
      </span>
    </TogglePrimitive.Root>
  );
