...
function createRouter() {
  ...
  return reactRouter({
    ...
    basepath: process.env.GITHUB_ACTIONS === "true" ? "/_donbass-post" : "/user", // @see (link: https://tanstack.com/router/v1/docs/framework/react/api/router/RouterOptionsType#basepath-property)
