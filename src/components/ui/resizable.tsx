  ...
  return (
    <ResizablePrimitive.PanelResizeHandle
      className={cn(
        ...
        "relative w-0.5 bg-sidebar-border hover:bg-accent data-[resize-handle-active]:bg-primary outline-none pointer-coarse:w-1.5",
    ...
    >
      {withHandle && (
        <div className="opacity-0 group-hover:opacity-100 group-hover:bg-accent group-data-[resize-handle-active]:opacity-100 group-data-[resize-handle-active]:bg-primary absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-8 w-2 flex justify-center items-center bg-sidebar-border rounded" />
      )}
    </ResizablePrimitive.PanelResizeHandle>
  );
};
