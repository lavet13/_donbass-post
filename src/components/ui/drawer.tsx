    ...
    <DrawerPrimitive.Portal>
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          ...
          "outline-none group/drawer-content fixed z-50 flex h-auto flex-col",
...
const DrawerHandle: FC<ComponentProps<typeof DrawerPrimitive.Handle>> = ({
  ...
  return (
    <DrawerPrimitive.Handle
      ...
      className={cn(
        "data-[vaul-handle]:bg-grayA-6! mx-auto mt-4 mb-1 hidden h-2 w-[100px] shrink-0 cursor-grab rounded-full active:cursor-grabbing sm:mb-0 lg:data-[vaul-handle]:hidden!",
        className,
      )}
      {...props}
    />
